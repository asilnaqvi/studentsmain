...
ActiveRecord::Schema.define(version: 20160421084909) do
  ...
  create_table "boards_schools", id: false, force: :cascade do |t|
  ...
  create_table "schools", force: :cascade do |t|
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
    t.string   "school_img_file_name"
    t.string   "school_img_content_type"
    t.integer  "school_img_file_size"
    t.datetime "school_img_updated_at"
    t.string   "name"
    t.string   "email"
    t.string   "phone"
    t.integer  "admin_id"
